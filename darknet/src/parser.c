...
linked_list *read_cfg(char *filename);
...
local_layer parse_local(linked_list *options, size_params params)
{
...
layer parse_deconvolutional(linked_list *options, size_params params)
{
    int n = option_find_int(options, "filters",1);
    int size = option_find_int(options, "size",1);
    int stride = option_find_int(options, "stride",1);
...
convolutional_layer parse_convolutional(linked_list *options, size_params params)
{
    int n = option_find_int(options, "filters",1);
    int size = option_find_int(options, "size",1);
    int stride = option_find_int(options, "stride",1);
...
layer parse_crnn(linked_list *options, size_params params)
{
...
layer parse_rnn(linked_list *options, size_params params)
{
...
layer parse_gru(linked_list *options, size_params params)
{
    int output = option_find_int(options, "output",1);
    int batch_normalize = option_find_int_quiet(options, "batch_normalize", 0);
...
layer parse_lstm(linked_list *options, size_params params)
{
    int output = option_find_int(options, "output", 1);
    int batch_normalize = option_find_int_quiet(options, "batch_normalize", 0);
...
layer parse_connected(linked_list *options, size_params params)
{
    int output = option_find_int(options, "output",1);
    char *activation_s = option_find_str(options, "activation", "logistic");
    ACTIVATION activation = get_activation(activation_s);
...
softmax_layer parse_softmax(linked_list *options, size_params params)
{
    int groups = option_find_int_quiet(options, "groups",1);
...
layer parse_region(linked_list *options, size_params params)
{
...
detection_layer parse_detection(linked_list *options, size_params params)
{
...
cost_layer parse_cost(linked_list *options, size_params params)
{
...
crop_layer parse_crop(linked_list *options, size_params params)
{
...
layer parse_reorg(linked_list *options, size_params params)
{
    int stride = option_find_int(options, "stride",1);
...
maxpool_layer parse_maxpool(linked_list *options, size_params params)
{
    int stride = option_find_int(options, "stride",1);
...
avgpool_layer parse_avgpool(linked_list *options, size_params params)
{
    int batch,w,h,c;
    w = params.w;
    h = params.h;
...
dropout_layer parse_dropout(linked_list *options, size_params params)
{
...
layer parse_normalization(linked_list *options, size_params params)
{
...
layer parse_batchnorm(linked_list *options, size_params params)
{
    layer l = make_batchnorm_layer(params.batch, params.w, params.h, params.c);
    return l;
}

layer parse_shortcut(linked_list *options, size_params params, network *net)
{
...
layer parse_activation(linked_list *options, size_params params)
{
    char *activation_s = option_find_str(options, "activation", "linear");
    ACTIVATION activation = get_activation(activation_s);
...
route_layer parse_route(linked_list *options, size_params params, network *net)
{
...
void parse_net_options(linked_list *options, network *net)
{
...
{
	linked_list *sections = read_cfg(filename);
